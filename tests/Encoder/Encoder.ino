...
void setup() {
    ...
    // set 2ms as long press duration (default is 1ms) :
    // versatile_encoder->setReadIntervalDuration(2); 
    // set 35ms as short press duration (default is 50ms)
    // versatile_encoder->setShortPressDuration(35);
    // set 550ms as long press duration (default is 1000ms) :
    // versatile_encoder->setLongPressDuration(550); 
    // set 350ms as double press duration (default is 250ms) :
    // versatile_encoder->setDoublePressDuration(350); 
